...
export const env = {
  ...
  username,
  password,
  loginPath: stringValue('LOGIN_PATH', '/login'),
  authenticatedPath: stringValue('AUTHENTICATED_PATH', '/'),
  usernameSelector: stringValue('USERNAME_SELECTOR', 'input[name="username"]'),
